    ...
    <div className={classes.root} id="ConfigurationContent">
      <AppBar position="static" color="default">
        <Tabs
          ...
          variant="fullWidth"
        >
          <Tab className={classes.tab} label="Ajouter d'autre Fournisseurs" icon={<PostAddIcon />} {...a11yProps(0)} />
          <Tab className={classes.tab} label="Liste des Fournisseurs" icon={<ViewListIcon />} {...a11yProps(1)} />
        </Tabs>
      </AppBar>
