    ...
    <div className={classes.root} id="ConfigurationContent">
      <AppBar position="static" color="default">
        <Tabs
          ...
          variant="fullWidth"
        >
          <Tab className={classes.tab} label="Ajouter Utilisateur" icon={<PostAddIcon />} {...a11yProps(0)} />
          <Tab className={classes.tab} label="Liste des Utilisateurs" icon={<ViewListIcon />} {...a11yProps(1)} />
        </Tabs>
      </AppBar>
