    ...
    constructor(props) {
      super();
        this.state = {
          ...
          dense:false,
          selectedRow: null,
          Title:"Equipements informatique en reparation"
        };
...
render(){
    const { error, isLoaded, items,Title ,selectedRow} = this.state;
    if (error) {
      ...
      return <div><Loading_Item /></div>;
        ...
        return (
          ...
          <MaterialTable
            ...
            title={Title}
            columns={[
              { title: 'Designation', field: 'description_Fr',width:"10%" },
              { title: 'Type', field: 'type.description_Fr',width:"10%" },
              { title: 'Marque', field: 'marque.description_Fr',width:"10%" },
              { title: 'Categorie', field: 'categorie.description_Fr',width:"10%" },
              { title: 'Observation', field: 'observation',width:"20%" },
              { title: 'Num serie', field: 'num_serie',width:"15%" },
            ...
            actions={[
              ...
              },
              {
                ...
                tooltip: 'Delete User',
                onClick: (event,rowData) => this.DeleteThis(rowData._id)
              }
            ]}
